...
lamda_link('<p>hartmanm/d3_road_deaths</p>','13','https://github.com/hartmanm/d3_road_deaths?tab=License-1-ov-file',five);
lamda_link('<p>hartmanm/oros_nv</p>','4','https://github.com/hartmanm/oros_nv?tab=License-1-ov-file',six);
lamda_link('<p>hartmanm/overlord_nv</p>','5','https://github.com/hartmanm/overlord_nv?tab=License-1-ov-file',seven);
lamda_link('<p>hartmanm/methods</p>','6','https://github.com/hartmanm/methods?tab=License-1-ov-file',eight);
lamda_link('<p>hartmanm/ticker</p>','7','https://github.com/hartmanm/ticker?tab=License-1-ov-file',nine);
lamda_link('<p>hartmanm/mining_electric_cost_calculator</p>','9','https://github.com/hartmanm/mining_electric_cost_calculator',ten);
lamda_link('<p>hartmanm/pavo_td</p>','10','https://github.com/hartmanm/pavo_td?tab=License-1-ov-file',eleven);
lamda_link('<p>hartmanm/simpleB</p>','12','https://github.com/hartmanm/simpleB?tab=License-1-ov-file',twelve);
lamda_link('<img src="hartmanm_avatar.png" style="width:15%;height:15%;"/>','11','https://github.com/hartmanm',thirteen);
