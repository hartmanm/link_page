...
lamda_link('<p>hartmanm/mnh_license</p>','2024','https://github.com/hartmanm/mnh_license/tree/main?tab=License-1-ov-file',one);
...
lamda_link('<p>hartmanm/bash_simple_server</p>','2019','https://github.com/hartmanm/bash_simple_server?tab=License-1-ov-file',six);
lamda_link('<p>hartmanm/oros_nv</p>','2018','https://github.com/hartmanm/oros_nv?tab=License-1-ov-file',seven);
...
lamda_link('<p>hartmanm/ticker</p>','7','https://github.com/hartmanm/ticker?tab=License-1-ov-file',ten);
lamda_link('<p>hartmanm/mining_electric_cost_calculator</p>','9','https://github.com/hartmanm/mining_electric_cost_calculator',eleven);
lamda_link('<p>hartmanm/pavo_td</p>','2017','https://github.com/hartmanm/pavo_td?tab=License-1-ov-file',twelve);
lamda_link('<p>hartmanm/simpleB</p>','2016','https://github.com/hartmanm/simpleB?tab=License-1-ov-file',thirteen);
lamda_link('<img src="hartmanm_avatar.png" style="width:15%;height:15%;"/>','11','https://github.com/hartmanm',fourteen);
