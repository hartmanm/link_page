...
lamda_link('<p>hartmanm/mnh_license</p>','1','https://github.com/hartmanm/mnh_license/tree/main?tab=License-1-ov-file',intro);
lamda_link('<p>hartmanm/typed</p>','2','https://github.com/hartmanm/typed?tab=License-1-ov-file',zero);
//lamda_link('<img src="xyz.png" style="width:50%;height:50%;"/>','1dfg','title_url',zero);
lamda_link('<p>hartmanm/d3_clock</p>','3','https://github.com/hartmanm/d3_clock?tab=License-1-ov-file',zero_one);
lamda_link('<p>hartmanm/overlord_nv</p>','4','https://github.com/hartmanm/overlord_nv?tab=License-1-ov-file',one);
lamda_link('<p>hartmanm/oros_nv</p>','5','https://github.com/hartmanm/oros_nv?tab=License-1-ov-file',two);
lamda_link('<p>hartmanm/22mines</p>','6','https://github.com/hartmanm/22mines?tab=License-1-ov-file',three);
...
lamda_link('<p>hartmanm/hs_server</p>','7','https://github.com/hartmanm/hs_server',four);
