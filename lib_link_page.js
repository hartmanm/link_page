...
lamda_link('<p>hartmanm/typed</p>','2021','https://github.com/hartmanm/typed?tab=License-1-ov-file',three);
lamda_link('<p>hartmanm/d3_clock</p>','2020_L','https://github.com/hartmanm/d3_clock?tab=License-1-ov-file',four);
lamda_link('<p>hartmanm/d3_road_deaths</p>','2020','https://github.com/hartmanm/d3_road_deaths?tab=License-1-ov-file',five);
lamda_link('<p>hartmanm/bash_simple_server</p>','2019_1','https://github.com/hartmanm/bash_simple_server?tab=License-1-ov-file',six);
lamda_link('<p>hartmanm/oros_nv</p>','2018_L','https://github.com/hartmanm/oros_nv?tab=License-1-ov-file',seven);
lamda_link('<p>hartmanm/overlord_nv</p>','5','https://github.com/hartmanm/overlord_nv?tab=License-1-ov-file',eight);
lamda_link('<p>hartmanm/methods</p>','6','https://github.com/hartmanm/methods?tab=License-1-ov-file',nine);
lamda_link('<p>hartmanm/ticker</p>','2018_3','https://github.com/hartmanm/ticker?tab=License-1-ov-file',ten);
lamda_link('<p>hartmanm/mining_electric_cost_calculator</p>','2018_2','https://github.com/hartmanm/mining_electric_cost_calculator',eleven);
lamda_link('<p>hartmanm/resume_site</p>','2018_1','https://github.com/hartmanm/resume_site?tab=License-1-ov-file',twelve);
lamda_link('<p>hartmanm/pavo_td</p>','2017','https://github.com/hartmanm/pavo_td?tab=License-1-ov-file',thirteen);
lamda_link('<p>hartmanm/simpleB</p>','2016','https://github.com/hartmanm/simpleB?tab=License-1-ov-file',fourteen);
lamda_link('<img src="hartmanm_avatar.png" style="width:15%;height:15%;"/>','11','https://github.com/hartmanm',fifteen);
