...
//lamda_link('<img src="xyz.png" style="width:50%;height:50%;"/>','1dfg','title_url',two);
////lamda_link(d3_clock,three);
lamda_link('<p>hartmanm/d3_clock</p>','3','https://github.com/hartmanm/d3_clock?tab=License-1-ov-file',four);
lamda_link('<p>hartmanm/overlord_nv</p>','4','https://github.com/hartmanm/overlord_nv?tab=License-1-ov-file',five);
lamda_link('<p>hartmanm/oros_nv</p>','5','https://github.com/hartmanm/oros_nv?tab=License-1-ov-file',six);
lamda_link('<p>hartmanm/22mines</p>','6','https://github.com/hartmanm/22mines?tab=License-1-ov-file',seven);
//lamda_link('<img src="xyz.png" style="width:50%;height:50%;"/>','4','title_url',seven);
//lamda_link('<img src="xyz.png" style="width:50%;height:50%;"/>','4asdf44','title_url',seven);
//lamda_link('<img src="xyz.png" style="width:50%;height:50%;"/>','444','title_url',seven);
lamda_link('<p>hartmanm/hs_server</p>','7','https://github.com/hartmanm/hs_server',eight);
lamda_link('<img src="hartmanm_avatar.png"/>','zzzz','https://github.com/hartmanm',footer);
