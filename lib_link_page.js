...
lamda_link('<p>hartmanm/typed</p>','2021','https://github.com/hartmanm/typed?tab=License-1-ov-file',four);
lamda_link('<p>hartmanm/d3_clock</p>','2020_L','https://github.com/hartmanm/d3_clock?tab=License-1-ov-file',five);
lamda_link('<p>hartmanm/d3_road_deaths</p>','2020','https://github.com/hartmanm/d3_road_deaths?tab=License-1-ov-file',six);
lamda_link('<p>hartmanm/bash_simple_server</p>','2019_1','https://github.com/hartmanm/bash_simple_server?tab=License-1-ov-file',seven);
lamda_link('<p>hartmanm/oros_nv</p>','2018_L','https://github.com/hartmanm/oros_nv?tab=License-1-ov-file',eight);
lamda_link('<p>hartmanm/overlord_nv</p>','5','https://github.com/hartmanm/overlord_nv?tab=License-1-ov-file',nine);
lamda_link('<p>hartmanm/methods</p>','6','https://github.com/hartmanm/methods?tab=License-1-ov-file',ten);
